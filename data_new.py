# -*- coding: utf-8 -*-
"""第 26、27 期真实新闻素材（2026.08.17 — 08.21），来源均来自联网检索。
每条 pick / news-item 的 src+url 指向实际检索到的来源页面。"""
...
# ===================== 第 26 期（周三 2026.08.19，窗口 08.17–08.19） =====================
{
 ...
 "picks": [
  ...
  ("IPO", "Anthropic 筹备 IPO：为创始人设超级投票权股份，估值约 2 万亿美元",
   "据 The Information 8 月 18 日报道，Anthropic 正为联合创始人准备附带额外投票权的股份，以隔离外部压力、为计划中的 IPO 铺路；此前其年化收入已达 650 亿美元，市场传闻估值约 2 万亿美元，上市窗口指向 10 月。若以此估值登陆，Anthropic 将与 SpaceX 争夺 2026 年最大规模融资。投资者对其盈利能力的预期也在升温——有分析称其 Q2 运营利润达 5.59 亿美元。",
   "aisort.net", "https://www.aisort.net/ai_news/20260815/anthropic-ipo-2-trillion-valuation/"),
  ...
  ("模型", "Claude Opus 4.5 发布：SWE-bench 80.9% 重夺编码王座，价格直降 2/3",
   ...
   "blog.csdn.net", "https://blog.csdn.net/enheng1238/article/details/163878719"),
 ...
 "sections": [
  ("模型与技术进展", [
   ("发布", "GPT-5.2 定档 12 月：ARC-AGI-2 达 52.9%，抽象推理大幅领先",
    "LLM Stats 榜单显示 GPT-5.2（12 月发布）在 ARC-AGI-2 达 52.9%（Thinking）/54.2%（Pro），大幅领先 Opus 4.5 的 37.6% 与 Gemini 3 Deep Think 的 45.1%；AIME 2025 无工具满分，自研 GDPval 基准声称 70.9% 场景胜过行业专业人士。前沿模型的竞争焦点，正从「答题」转向「自主把活干完」的长程推理。",
    "blog.csdn.net", "https://blog.csdn.net/enheng1238/article/details/163878719"),
   ("开源", "Gemini 3.7 Flash 以 0.75/3.75 限时价抢开发者，2027 年起翻倍",
    "Google 8 月 12 日发布 Gemini 3.7 Flash：WebDev Arena Elo 1588，限时入门价 0.75/3.75（每百万 token），并预告 2027 年 1 月 1 日起翻倍至 1.5/7.5。AI Business 解读为「低价吸引开发者再涨价」的经典 SaaS 打法；同期 Gemma 4 开源家族（2B–31B）强化小模型路线。",
    "blog.csdn.net", "https://blog.csdn.net/enheng1238/article/details/163878719"),
  ...
  ("国内 AI 动态", [
   ...
   ("发布", "五一视界办「物理 AI 工厂」发布会，51Sim 收入同比 +545%",
    ...
    "baijiahao.com", "https://baijiahao.baidu.com/s?id=1873872973473158202"),
  ...
  ("国际 AI 动态", [
   ...
   ("融资", "Etched 融资 7 亿美元、估值 210 亿：专做 transformer 推理芯片",
    ...
    "theneuron.ai", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
   ("政策", "近 200 家硅谷企业联署致信白宫：反对限制中国开源大模型",
    "近 200 家硅谷科技企业联名致信白宫，反对限制中国开源大模型的访问；英伟达、微软、Meta 等巨头参与联署。企业界的诉求很现实：中国开源模型已是全球开发者生态与自身产品链的一部分，限制访问将反噬美国公司的工程效率与成本结构。",
    "baijiahao.com", "https://baijiahao.baidu.com/s?id=1873914585033778994"),
  ]),
  ("AI 与金融", [
   ("融资", "Physical AI H1 募资 474 亿美元，Waymo/Anduril 领跑",
    ...
    "crunchbase.com", "https://news.crunchbase.com/"),
 ...
 "sections": [
  ...
  ("国际 AI 动态", [
   ("IPO", "Anthropic 密集巩固资本结构，IPO 前夜信贷超 100 亿",
    ...
    "bloomberg.com", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
   ("融资", "Etched 7 亿美元、估值 210 亿，专用推理芯片升温",
    ...
    "reuters.com", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
  ...
  ("AI 与金融", [
   ...
   ("市场", "欧央行再警 AI 股回调风险，狂热与审慎并存",
    ...
    "cnbc.com", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
  ]),
  ("政策与监管", [
  ...
  ("社媒与开发者社区观察", [
   ("争议", "ChatGPT「治疗师」事件持续发酵，未成年人保护成底线",
    ...
    "npr.org", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
   ("研究", "多 Agent 编码：共享文件砍 42% token，命名 coordinator 无提升",
    "（见第 26 期）1902 次运行的实证结论，为「如何搭多 Agent」提供了可量化经验，也提醒「堆 agent 不等于更好」。",
    "arxiv.org", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
   ("观点", "「Anthropic Derangement Syndrome」成梗，开发者激辩放缓叙事",
    ...
    "x.com", "https://www.theneuron.ai/digest/everything-that-happened-in-ai-today-tuesday-august-18-2026/"),
  ]),
 ]
},
